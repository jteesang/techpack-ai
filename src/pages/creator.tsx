                  ...
                  { uploading === true ? (
                    <div className="animate-pulse rounded-lg">
                      <textarea
                        ...
                        readOnly
                        placeholder={''}
                        className="bg-gray-200 block w-full px-3 py-2 rounded-lg resize-none focus:outline-none focus:ring-0 "
                        rows={8}
                        disabled
                      />
                    </div>
                    ...
                    <textarea
                      ...
                      readOnly
                      placeholder={''}
                      className="block w-full px-3 py-2 rounded-lg resize-none focus:outline-none focus:ring-0"
                      rows={8}
                    />
                  )}
                  <div className="text-gray-400 italic text-center text-sm p-2">AI generated descriptions may be incorrect.</div>
                </div>
              </div>
            </div>
